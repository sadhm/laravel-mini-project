    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="index.html">
                <i class="menu-icon typcn typcn-document-text" href="{{route('admin.index')}}"></i>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="back/pages/samples/error-404.html"> 404 </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="back/pages/samples/error-500.html"> 500 </a>
                    </li>
                </ul>
            </div>
        </li>
